...
channel_group = 3  # 👈 Customize the channel group to use
year = ['2019','2020']
# ==== Global Paths ====
...
def train_srgan_ddp(
    ...
    d_optimizer = optim.Adam(D.parameters(), lr=2e-6, betas=(0.9, 0.999))
    ...
    for epoch in range(n_epoch):
        ...
        for batch in train_loader_adv:
            ...
            g_loss = pixel_loss + 5e-2 * adv_loss 
...
def evaluate_adversarial(G, D, val_loader, device, rank=0, amp=False):
    ...
    total_val_loss = avg_mse + 5e-2 * avg_adv 
